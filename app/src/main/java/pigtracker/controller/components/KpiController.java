...
public class KpiController {
    ...
    private static final Image UP_IMAGE = new Image(
            KpiController.class.getResourceAsStream("/images/upwards_64.png"));
    private static final Image DOWN_IMAGE = new Image(
            KpiController.class.getResourceAsStream("/images/downwards_64.png"));
    ...
    @FXML private ImageView trendIcon;
    @FXML private LineChart<String, Number> sparklineChart;
